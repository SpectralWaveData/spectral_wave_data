...
zip_name = 'swd_lib_static_c_win64_%s' % version_full
...
os.mkdir(inc_dir)
shutil.copy(os.path.join('..', 'spectral_wave_data.h'), inc_dir)
...
The 'inc' folder contains the relevant C-header file to include
in your C-program.
