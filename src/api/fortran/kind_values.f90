...
integer, public, parameter :: kind_swd_interface = double  ! Fortran interface
integer, public, parameter :: kind_swd_internal = real64   ! Precision applied inside SWD API
