...
character(len=*), parameter :: err_proc = 'spectral_wave_data_shape_3_impl_1::elev_fft'
...
character(len=*), parameter :: err_proc = 'spectral_wave_data_shape_3_impl_1::grad_phi_fft'
character(len=:), allocatable :: err_msg(:)
