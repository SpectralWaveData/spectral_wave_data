...
demonstrating all features of the API in all of these languages follows
...
For python this is simply a matter of::

   pip install spectral_wave_data

and PyPI will install the platform dependent package in your regular Python site-package.
Hence, you may apply this API directly in your application.
